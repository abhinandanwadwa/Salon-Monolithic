import { verifyUser,ChangeRole,logout ,sendOTP,verifyOTP,verifyToken,addName,verifyOwner,LoginAdmin,RegisterAdmin,getSalonsubAdmins,removesubAdmin,deleteOwner} from "../Controllers/Auth.controller.js";
